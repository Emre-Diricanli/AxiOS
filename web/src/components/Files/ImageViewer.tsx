    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={onClose}>
      ...
      {hasPrev && (
        <button
          ...
          className="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors backdrop-blur-sm"
        >
      ...
      {hasNext && (
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors backdrop-blur-sm"
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <img
        ...
        className={`relative z-10 max-h-[85vh] rounded-lg shadow-2xl transition-all duration-200 ${
          zoom
            ? "max-w-none cursor-zoom-out scale-150"
            : "max-w-[90vw] cursor-zoom-in"
        }`}
