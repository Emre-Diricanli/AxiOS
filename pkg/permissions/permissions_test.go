...
func TestShippedConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{"search_notes trusted", "axios-obsidian__search_notes", map[string]any{"query": "meeting"}, Trusted},
		...
		{"write_note needs approval", "axios-obsidian__write_note", map[string]any{"path": "Work/x.md"}, ApprovalRequired},
